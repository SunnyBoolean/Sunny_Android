...
public class CalendarView extends View implements View.OnTouchListener {
	...
	private Date downDate; // 手指按下状�?时临时日�?
	private Date showFirstDate, showLastDate; // 日历显示的第�?��日期和最后一个日�?
	...
	private boolean completed = false; // 为false表示只�?择了�?��日期，true表示结束日期也�?择了
	...
	private void drawCellBg(Canvas canvas, int index, int color) {
		...
		//绘制背
		canvas.drawText("("+mItemCount+")", left+5, top+20, surface.mItemCountPaint);
	}
	...
	private class Surface {
		...
		/** 按下所选择的的单元格的背景颜色*/
		public int cellDownColor = Color.parseColor("#CD919E");
		public int cellSelectedColor = Color.parseColor("#99CCFF");
		/** 形成安排数目颜色*/
		public int itemCount = Color.parseColor("#EE00EE");
		...
		public void init() {
			...
			mItemCountPaint = new Paint();
			mItemCountPaint.setColor(itemCount);
			mItemCountPaint.setTextSize(16);
