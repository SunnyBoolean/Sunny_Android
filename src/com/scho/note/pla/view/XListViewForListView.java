...
public class XListViewForListView extends ListView implements OnScrollListener {
	 ...
	 * @param context
	 */
	public XListViewForListView(Context context) {
		super(context);
		initWithContext(context);
	}

	public XListViewForListView(Context context, AttributeSet attrs) {
		super(context, attrs);
		initWithContext(context);
	}

	public XListViewForListView(Context context, AttributeSet attrs, int defStyle) {
    ...
    {
    	mHeaderView.setHideText(hideText);
    }
